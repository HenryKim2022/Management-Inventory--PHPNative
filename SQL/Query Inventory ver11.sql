...
VALUES
('11111', 'M.', 'Ramdan Pujianto', 'Balarajda RT/RW01', 1),
('22222', 'Yopi Okta', '.R .W', 'Kademangan RT/RW01', 2),
('33333', 'Herry', 'Sukhairi', 'Cikarang RT/RW01', 1),
('44444', 'Farel Rabbani', '.P', 'Sanghiang RT/RW01', 1);
...
CREATE TABLE tb_login (
    ...
    login_status ENUM('Allowed', 'Blocked', 'Limited'),
...
VALUES
('11111', 'Allowed', NULL, '11111', 'Developer'),
('22222', 'Allowed', NULL, '22222', 'Developer'),
('33333', 'Blocked', NULL, '33333', 'Moderator'),
('44444', 'Limited', '2024-03-05 00:00:00', '44444', 'Admin');
...
-- if tb_br_in or tb_br_out have tb_stok.id_stockbarang then show alert 


-- Query to check if 
-- tb_part.id_part already used by tb_stok
...
-- Query to check if 
-- tb_divisi.id_divisi already used by tb_pegawai
