            ...
            <div class="card-header">
                <div class="row">
                    <div class="col-auto m-0">
                        <button class="btn btn-menutable btn-icon btn-transparent-dark me-2" data-bs-toggle="modal" data-bs-target="#addOutcomingGoodsModal"><i data-feather="plus"></i>
                            ADD
                        </button>
                    </div>
            ...
            <table id="datatablesSimple" cellspacing="0" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    $cekdb = mysqli_query(
                        ...
                        ORDER BY tb_br_out.updated_at DESC;
                        ",
                        ...
                        <tr>
                            ...
                            <td class="align-middle align-content-sm-between justify-content-center">
                                <div class="d-flex align-content-sm-between justify-content-center align-middle">
                                    <a id="<?= $res['id_brout'] ?>" data-bs-toggle="modal" data-bs-target="#editOutcomingGoodsModal" onclick="tfIDOCG(event, this.id)" class="view_data btn btn-datatable btn-icon btn-transparent-dark me-2">
                                        <i class="fi-ic-yellow" data-feather="edit"></i>
                                    </a>
                                    <a name="btnDelSelectedDiv" href="/fungsi/stock_funct.php?act=del&brout_id=<?= $res['id_brout'] ?>&return_qty=<?= $res['jmlh'] ?>" class="btn btn-datatable btn-icon btn-transparent-dark me-2" onclick="return confirm('Are you sure want to delete *<?= $tbTxtref ?>(<?= $res['namapart'] ?>) ?')">
        ...
        function tfIDOCG(event, id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#editOutcomingGoodsModal').modal('show');
                }
            })
        }
    </script>
...
<!-- Modal Add Outcoming Goods -->
<div class="modal fade" id="addOutcomingGoodsModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Add Outcoming Goods</h5>
            ...
            <form method="post" action="/fungsi/stock_funct.php">
                <div class="modal-body row">
                    <div class="input-group mb-3 justify-content-between align-items-start col-2">
                        ...
                        <div class="col-8 pr-0 mr-0">
                            <select id="addOutcomingPartID" name="addOutcomingPartID" class="form-control choices-single-1">
                                <option></option>
                                <?php $i = 1;
                                while ($res = mysqli_fetch_assoc($showtotable)) : ?>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="qtyGoodsOut" type="number" class="form-control col-sm-4" placeholder="Qty" value="1" min="1">
                    </div>
                    ...
                    <div class="input-group mb-3 justify-content-between">
                        ...
                        ?>
                        <div class="col-8 pr-0 mr-0">
                            <select id="AddPICOutNum" name="AddPICOutNum" class="form-control choices-single-2">
                                <option value=""></option>
                                <?php $i = 1;
                                while ($res = mysqli_fetch_assoc($showtotable)) : ?>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input name="outcomingDate" type="date" class="form-control col-xs-2" placeholder="Date" value="<?= date('Y-m-d'); ?>">
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="btnAddNewOutcoming">Save</button>
                </div>
            </form>
...
<!-- Modal Edit Outcoming Goods -->
<div class="modal fade" id="editOutcomingGoodsModal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Edit Outcoming Goods</h5>
                <button class="btn-close" type="button" data-bs-dismiss="modal"></button>
            </div>
