            ...
            if (isset(($_SESSION["toastMessages"]))) {
                ...
                if (session_status() == PHP_SESSION_NONE) {
                    echo "<script>
                        ...
                        var desiredPath = '$tbPgref';
                        var redirectUrl = baseUrl + desiredPath;
                        window.location.href = redirectUrl;
                    };
                    </script>";
                    session_start(); // Jika belum dimulai, mulai sesi
                    $_SESSION['toastMessages'][0] = "code_green";
                    $_SESSION['toastMessages'][1] = "1.1 > Data $tbTxtref($nama_id) added successfully :)";
                    // echo "<script> window.onload = function() {
                    //     window.location.href = '$tbPgref';
                    // }</script>";
                }
                ...
                $_SESSION['toastMessages'][0] = "code_green";
                $_SESSION['toastMessages'][1] = "1.2 > Data $tbTxtref($nama_id) added successfully :)";
                // header("location:$tbPgref");
            } else {
                if (session_status() == PHP_SESSION_NONE) {
                    echo "<script>
                    window.onload = function() {
                    ...
                    session_start(); // Jika belum dimulai, mulai sesi
                    $_SESSION['toastMessages'][0] = "code_green";
                    $_SESSION['toastMessages'][1] = "2.1 > Data $tbTxtref($nama_id) added successfully :)";
                    // echo "<script> window.onload = function() {
                    //     window.location.href = '$tbPgref';
                    // }</script>";
                }
                ...
                $_SESSION['toastMessages'][0] = "code_green";
                $_SESSION['toastMessages'][1] = "2.2 > Data $tbTxtref($nama_id) added successfully :)";
                // echo "<script> window.onload = function() {
                //     window.location.href = '$tbPgref';
                // }</script>";
            }
...
<?php
function setSessionValuesAndRedirect($tbPgref, $tbTxtref, $nama_id)
{
    session_start();
...
$result = setSessionValuesAndRedirect($tbPgref, $tbTxtref, $nama_id);

if ($result === true) {
    echo 'Session values set successfully';
} elseif ($result === false) {
    echo 'Invalid data';
}
?>